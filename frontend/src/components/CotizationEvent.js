...
const getLoginTemplate = () => {
    return `
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-medium text-gray-900 dark:text-white">
                    porfavor inicia sesion para hacer una otización
                </h3>
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <h1 class="text-base leading-relaxed text-gray-500 dark:text-gray-400">Debes iniciar sesión para realizar una cotización.</h1>
                          ...
                          <div id="loginIsLogged" >
                  <button id="loggedEvent" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                      Login
                  </button>
              </div>
            </div>
